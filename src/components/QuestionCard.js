    ...
    >
      <div className="flex flex-col justify-center items-center">
        <img src={user?.avatarURL}
          ...
          alt="author avatar"
        />
        <div className="text-sm px-1 text-white mt-1 mb-1 rounded-full bg-yellow-400">{user?.name}</div>
      ...
      <div className="flex flex-col  px-2 items-between">
        <div className="text-indigo-700 font-semibold">Would You Rather?</div>
        <hr className="mb-2"/>
        <div className="text-sm md:text-lg rounded-md text-indigo-500 px-1 border border-indigo-400 bg-indigo-100">
          <BsCheckCircle className="inline mr-2 rounded-full text-yellow-500 bg-yellow-100 border border-yellow-500 "/>{optionOne.text}
        </div>
        <span className="bg-yellow-400 text-white text-md w-8 rounded-md text-center m-2">OR</span>
        <div className="text-sm md:text-lg rounded-md text-indigo-500 px-1 border border-indigo-400 bg-indigo-100 mb-2">
